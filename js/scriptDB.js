...
function getTrains(){
	...
	for(i=1; i<=count;i++) {
		if(JSON.parse(localStorage.getItem(i+""))!= null){
			...
			$( '#cronologia' ).prepend("<li id='chrono_el'><a href='#' id='"+oggetto.id+"' class='history'><p style='font-size: 1.5rem;'>" + oggetto.stazionePartenza + oggetto.partenza + "</p><p style='font-size: 1.5rem;'>Direzione: " + oggetto.stazione + "</p></a></li>");
		}	
	}
}
